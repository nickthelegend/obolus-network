...
export default function Docs() {
    const categories = [
        { title: "Introduction", items: ["What is Obolus?", "Architecture", "Hydra Integration"] },
        ...
        { title: "Smart Contracts", items: ["Plutus V2", "Aiken Implementation", "Audits"] },
    ];
                    ...
                    <motion.div {...fadeInUp} className="max-w-3xl">
                        ...
                        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
                            {[
                                ...
                                { title: "SDKs", desc: "Libraries for JavaScript, Haskell, and Rust.", icon: "terminal" },
                        ...
                        <article className="prose prose-invert max-w-none text-slate-400">
                            ...
                            <p className="mb-6">
                                Obolus is built from the ground up to leverage Cardano's EUTXO model.
                                Our infrastructure is designed for parallel execution and predictable transaction costs.
                            </p>
